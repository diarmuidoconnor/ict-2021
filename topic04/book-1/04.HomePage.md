...
~~~
[Object destructuring is used on the props object ( {movies} ) purely for illustration purposes.]

Ultimately this page will be plugged into a routing component. In the meantime we will statically link it to a top-level component that feeds an array of movies to the HomePage component. Create `src/index.js` and code it as follows:
~~~
import React from "react";
