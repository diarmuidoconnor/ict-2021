...
To speed up the process and align more closely to the MovieDB API and the React App from previous labs, download the code archive for this topic(https://ewd-2021-wit.netlify.app/topic10/archive/archive.zip) and extract it into your **ewd-api-labs-2021** repo you created in the last lab. Rename the folder "node_lab2".
