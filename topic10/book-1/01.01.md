...
To speed up the process and align more closely to the MovieDB API and the React App from previous labs, download the **starter code archive for this topic** and extract it into your **ewd-api-labs-2021** repo you created in the last lab. Rename the folder "node_lab2".
