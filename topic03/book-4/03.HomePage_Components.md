...
+ The Typography component controls how text is displayed and how it is represented in the DOM - see [here](https://material-ui.com/components/typography/). In this example we want the text to display as a h6 header and be represented as a paragraph (p) in the DOM.
...
~~~
The back/forward arrows do not work yet. The Material Paper component can just be regarded as a general wrapper component (see [here](https://material-ui.com/components/paper/)).
