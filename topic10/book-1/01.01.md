...
To speed up the process and align more closely to the MovieDB API and the React App from previous labs, download the topic [Starter Code](https://ewd-2020-wit.netlify.app/topic10/archive/archive.zip) for this lab and place it into your **ewd-api-labs-2020** repo you created in the last lab.
