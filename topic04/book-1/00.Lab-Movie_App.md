...
+ Display a list of movies, showing the movie poster, title, release date and viewer rating.
+ Display more detailed information on one movies from the original list, detailing an overview, runtime, spoken languages, production companies, etc.
